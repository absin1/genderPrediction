...
public class PredictGenderTrain
{
    ...
    public static void main(String args[])
    {
        ...
        dg.filePath =  "C:\\Users\\Istar\\git\\dl4j-examples\\dl4j-examples\\src\\main\\resources\\PredictGender\\Data";
        dg.train();
        System.exit(0);
    }
    ...
    public void train()
    {
        ...
        try(GenderRecordReader rr = new GenderRecordReader(new ArrayList<String>() {{add("M");add("F");}}))
        {
            ...
            ModelSerializer.writeModel(model,"d:\\PredictGender.net",true);
